...
const Home=()=>
{
    return (
        <>  
            ...
            <p className="ss_desc desc_daily">Stay prepared for the coming days
             with our comprehensive weather forecast feature. Our website
              not only provides real-time updates for the current weather
               but also delivers reliable daily weather conditions for up
                to 10 days ahead.<br/><br/> Plan outdoor activities with confidence,
                 pack accordingly for trips, or stay informed about weather
                  trends in your area. From sunny days to stormy weather, 
                  our extended forecast ensures you're always in the know,
                   helping you make the most of every moment without being
                    caught off guard by unexpected weather changes.</p>
            ...
            <p className="ss_desc desc_hourly">Stay prepared for any weather
             changes with our hourly forecast feature. Our website provides
              detailed weather updates, giving you hourly insights into
               temperature, humidity, and other essential
